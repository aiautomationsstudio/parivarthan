...
// Individual Clinical Report Pages
import PatientProgressReport from './pages/clinical/reports/PatientProgressReport';
import PHQ9Reports from './pages/clinical/reports/PHQ9Reports';
import TreatmentSummaryReport from './pages/clinical/reports/TreatmentSummaryReport';
    ...
    <Routes>
      ...
      >
        ...
        <Route path="reports">
          ...
          <Route path="patient-progress" element={<PatientProgressReport />} />
          <Route path="patient-progress/:reportId" element={<PatientProgressReport />} />
          <Route path="phq9-reports" element={<PHQ9Reports />} />
          <Route path="treatment-summary" element={<TreatmentSummaryReport />} />
          <Route path=":reportId" element={<PatientProgressReport />} />
        </Route>
      </Route>
